...
20191118  Graph Transformer Networks  | gat的增强版--GTN  |  https://arxiv.org/pdf/1911.06455.pdf  
[]


20191119  [ROCC] 无监督证据句子选择增强多跳阅读理解  |  Quick and (not so) Dirty: Unsupervised Selection of Justification Sentences for Multi-hop Question Answering  |   https://arxiv.org/pdf/1911.07176.pdf  
{  
1. 目的: 通过无监督的学习加强多跳MRC证据句子选择判断能力  
    1.1 加强选择句子的相关性  
    1.2 减少所选择的事实之间的重叠  
    1.3 扩大问题、答案的范围  
2. 这种无监督的方法可以和任何有监督的方法结合保证质量；   
1. 通过IR选择之后的证据句子，然后生成 证据句子set  
2. 使用3个特定的分数选择得分 top n 的 证据句子；  
    2.1 基于选择证据句子之间的相关性   尽量扩大  
    2.2 基于选择句子事实之间的重叠  尽量缩小 
    2.3 基于与  问题和答案  范围:  尽量扩大   
}

20191119 [AAAI2020生成任务] 使用Graph Transformer[position embedding + node embedding + relation embedding ] |  Graph Transformer for Graph-to-Sequence Learning∗   
{
1. 机器翻译-AMR_Text生成  
2. 使用Transformer的类似结构进行学习去学习  
}


20191120    

20191121   Distractor Generation for Multiple Choice Questions Using Learning to Rank   |  http://clgiles.ist.psu.edu/pubs/naacl18_bea.pdf   
{}    

20191121 [RACE]Automatic multiple choice question generation from text : A survey     
{}  

20191121  [RACE]Generating distractors for reading comprehension questions  from real examinations     
{}  
20191121 [race]  Co-Attention Hierarchical Network: Generating Coherent Long Distractors for Reading Comprehension  |  https://arxiv.org/pdf/1911.08648.pdf  
{
1. 为RACE生成干扰选项
}
